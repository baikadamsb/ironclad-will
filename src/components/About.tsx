        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-muted-foreground text-lg leading-relaxed">
              <p>
                <strong className="text-foreground">15 лет опыта</strong> в боевых искусствах и профессиональной подготовке спортсменов. Мастер спорта, многократный чемпион региональных и всероссийских соревнований.
              </p>
              <p>
              ...
              <p>
                <strong className="text-foreground">Результаты учеников</strong>: более 50 призёров региональных турниров, 12 мастеров спорта, сотни детей и взрослых, открывших для себя силу единоборств.
              </p>
            </div>
